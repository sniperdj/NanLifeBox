...
//        self.setupUI()
    ...
    func setupChildViewControllers() {
        ...
        let tabbarItemHome = UITabBarItem(title: "home", image: nil, selectedImage: nil)
        self.addOneChildController(controller: homeController, atabbarItem: tabbarItemHome)
        
        let enjoyController = NLBEnjoyController(nibName: "NLBEnjoyController", bundle: nil)
        let tabbarItemEnjoy = UITabBarItem(title: "enjoy", image: nil, selectedImage: nil)
        self.addOneChildController(controller: enjoyController, atabbarItem: tabbarItemEnjoy)
        
        let myController = NLBMyController(nibName: "NLBMyController", bundle: nil)
        let tabbarItemMy = UITabBarItem(title: "my", image: nil, selectedImage: nil)
